// -----------------------------------------------------------------------------------------
// Main Senior Design Code (Version 3)
...
// use of a slider.
//
// This code reworks the case switch loop by allowing the user to first decide which set
// of probes to use in which direction they choose.
//
